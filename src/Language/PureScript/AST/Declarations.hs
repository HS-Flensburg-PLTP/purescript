...
data NameSource = UserNamed | CompilerNamed
  deriving (Data, Show, Generic, NFData, Serialise)
...
data ExportSource = ExportSource
  ...
  deriving (Data, Eq, Ord, Show, Generic, NFData, Serialise)
...
data ImportDeclarationType
  ...
  deriving (Data, Eq, Show, Generic, Serialise, NFData)
...
data ValueDeclarationData a = ValueDeclarationData
  ...
  deriving (Data, Show, Functor, Generic, NFData, Foldable, Traversable)
...
data PathNode t = Leaf t | Branch (PathTree t)
  deriving (Data, Show, Eq, Ord, Generic, NFData, Functor, Foldable, Traversable)
